...
public class CheckEntriesSellOutValidImeiAdapter extends ArrayAdapter<CheckEntriesSellOutImeiMonthYearsList> {


    public CheckEntriesSellOutValidImeiAdapter(Context context, ArrayList<CheckEntriesSellOutImeiMonthYearsList> yearsLists) {
