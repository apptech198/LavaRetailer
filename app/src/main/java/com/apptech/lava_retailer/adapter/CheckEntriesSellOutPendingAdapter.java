...
public class CheckEntriesSellOutPendingAdapter extends ArrayAdapter<CheckEntriesSellOutImeiMonthYearsList> {

    public CheckEntriesSellOutPendingAdapter(Context context, ArrayList<CheckEntriesSellOutImeiMonthYearsList> yearsLists) {
