...
*/
    ...
    private void getProduct(){
        ...
        lavaInterface.PRODUCT_LIST2(brandid , retailer_id,locality_id , Country_id , Country_name).enqueue(new Callback<Object>() {
                        ...
                        if (error.equalsIgnoreCase("false")) {
                            ...
                            for (int i=0 ; i< jsonArray.length(); i++) {
                                ...
                                productLists.add(new ProductList(
                                        object.optString("id")
                                        ,object.optString("marketing_name")
                                        ,object.optString("marketing_name_ar")
                                        ,object.optString("marketing_name_fr")
                                        ,object.optString("des")
                                        ,object.optString("des_ar")
                                        ,object.optString("des_fr")
                                        ,object.optString("actual_price")
                                        ,object.optString("dis_price")
                                        ,object.optString("thumb")
                                        ,object.optString("thumb_ar")
                                        ,object.optString("sku")
                                        ,object.optString("commodity_id")
                                        ,object.optString("format")
                                        ,object.optString("commodity")
                                        ,object.optString("commodity_ar")
                                        ,object.optString("brand_id")
                                        ,object.optString("brand")
                                        ,object.optString("brand_ar")
                                        ,object.optString("model")
                                        ,object.optString("model_ar")
                                        ,object.optString("category")
                                        ,object.optString("serialized")
                                        ,object.optString("video")
                                        ,object.optString("video_ar")
                                        ,object.optString("prowar")
                                        ,object.optString("pro_war_days")
                                        ,object.optString("battery_war")
                                        ,object.optString("battery_war_days")
                                        ,object.optString("charging_adapter_war")
                                        ,object.optString("charging_adapter_war_days")
                                        ,object.optString("charger_war")
                                        ,object.optString("charger_war_days")
                                        ,object.optString("usb_war")
                                        ,object.optString("usb_war_days")
                                        ,object.optString("wired_earphone_war")
                                        ,object.optString("wired_earphone_war_days")
                                        ,object.optString("available_qty")
                                        ,object.optString("hide")
                                        ,object.optString("total_sale")
